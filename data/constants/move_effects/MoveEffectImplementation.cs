...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
		...
		public static async Task<u32> Effect_Explosion(MoveEffectParams p) {
			...
			if (p.battle.FieldMonAbilityProc(Ability.DAMP, true)) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_CANNOT_USE_MOVE, p.attacker.GetName(), Lang.GetMoveName(p.moveID)));
				return 0;
			}
		...
		public static async Task<u32> Effect_Haze(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.STAT_CHANGES_ELIMINATED));
			return 0;
		}
		public static async Task<u32> Effect_Bide(MoveEffectParams p) {
			if (p.attacker.HasStatus(Status.CHARGING_TURN) && p.attacker.HasStatus(Status.BIDE)) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_UNLEASHED_ITS_ENERGY, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_Mist(MoveEffectParams p) {
			...
			p.state.SetSideCondition(p.attacker.Side, Condition.MIST, 5);

			if (p.attacker.Side == Battle.SIDE_CLIENT){
				MessageBox(Lang.GetBattleMessage(BattleMessage.YOUR_TEAM_BECAME_SHROUDED_IN_MIST));
			}
			else {
				MessageBox(Lang.GetBattleMessage(BattleMessage.OPPOSING_TEAM_BECAME_SHROUDED_IN_MIST));
			}
		...
		public static async Task<u32> Effect_FocusEnergy(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_GETTING_PUMPED, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_LeechSeed(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_WAS_SEEDED, p.target.GetName()));
		...
		public static async Task<u32> Effect_Splash(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.NOTHING_HAPPENED));
			return 0;
		}
		public static async Task<u32> Effect_Disable(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MONS_MOVE_WAS_DISABLED, p.target.GetName(), Lang.GetMoveName(p.target.moves[slot])));
		...
		public static async Task<u32> Effect_Encore(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_MUST_DO_AN_ENCORE, p.target.GetName()));
		...
		public static async Task<u32> Effect_Snore(MoveEffectParams p) {
			if (p.attacker.IsAsleep()) {
				...
				MessageBox(Lang.GetBattleMessage(BattleMessage.MOVE_FAILED));
				return FLAG_MOVE_FAILED;
			}
			return 0;
		}
		public static async Task<u32> Effect_LockOn(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_TOOK_AIM_AT_MON, p.attacker.GetName(), p.target.GetName()));
		...
		public static async Task<u32> Effect_Sketch(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SKETCHED_MOVE, p.attacker.GetName(), Lang.GetMoveName(idOfMoveToSketch)));
		...
		public static async Task<u32> Effect_DestinyBond(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_USED_DESTINY_BOND, p.attacker.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Spite(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MONS_PP_WAS_REDUCED, p.target.GetName()));
		...
		public static async Task<u32> Effect_MeanLook(MoveEffectParams p) {
			p.target.GiveStatus(Status.CANT_ESCAPE);
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_CAN_NO_LONGER_ESCAPE, p.target.GetName()));
			return 0;
		}
		public static async Task<u32> Effect_Nightmare(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_HAVING_NIGHTMARE, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Protect(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_PROTECTED_ITSELF, p.target.GetName()));
		...
		public static async Task<u32> Effect_PerishSong(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.PERISH_SONG));
			return 0;
		}
		public static async Task<u32> Effect_Endure(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_BRACED_ITSELF, p.target.GetName()));
		...
		public static async Task<u32> Effect_Safeguard(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_PROTECTED_BY_SAFEGUARD, p.attacker.GetName()));
			p.state.SetSideCondition(p.attacker.Side, Condition.SAFEGUARD, 5);
			return 0;
		}
		public static async Task<u32> Effect_Magnitude(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MAGNITUDE_N, scale));
		...
		public static async Task<u32> Effect_Torment(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_IS_TORMENTED, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_FollowMe(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_BECAME_CENTER_OF_ATTENTION, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Charge(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_CHARGING_POWER, p.target.GetName()));
			return 0;
		}
		public static async Task<u32> Effect_Taunt(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_FELL_FOR_THE_TAUNT, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Yawn(MoveEffectParams p) {
			...
			if (!p.target.CanFallAsleep(p.state)) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_CANNOT_FALL_ASLEEP, p.target.GetName()));
				return 0;
			}
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_IS_DROWSING, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Imprison(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SEALED_SHARED_MOVES, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_SmackDown(MoveEffectParams p) {
			...
			if (!p.target.IsGrounded(p.state)) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_FELL_STRAIGHT_DOWN, p.target.GetName()));
			}
			return flags;
		}
		...
		public static async Task<u32> Effect_WaterSport(MoveEffectParams p) {
			p.state.SetFieldCondition(Condition.WATER_SPORT, 5);
			MessageBox(Lang.GetBattleMessage(BattleMessage.WATER_SPORT_START));
			return 0;
		}
		public static async Task<u32> Effect_MudSport(MoveEffectParams p) {
			p.state.SetFieldCondition(Condition.MUD_SPORT, 5);
			MessageBox(Lang.GetBattleMessage(BattleMessage.MUD_SPORT_START));
			return 0;
		}
		...
		public static async Task<u32> Effect_AquaRing(MoveEffectParams p) {
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SURROUNDED_ITSELF_WITH_A_VEIL_OF_WATER, p.target.GetName()));
		...
		public static async Task<u32> Effect_Autotomize(MoveEffectParams p) {
			if (await Effect_SpeedUp2(p) != 0) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_BECAME_NIMBLE, p.target.GetName()));
		...
		public static async Task<u32> Effect_ClangorousSoul(MoveEffectParams p) {
			...
			ChangeStat(p.state, p.target, 1, Stat.ATTACK);
			ChangeStat(p.state, p.target, 1, Stat.DEFENSE);
			ChangeStat(p.state, p.target, 1, Stat.SPECIAL_ATTACK);
			ChangeStat(p.state, p.target, 1, Stat.SPECIAL_DEFENSE);
			ChangeStat(p.state, p.target, 1, Stat.SPEED);
			ChangeStat(p.state, p.target, 1, Stat.ACCURACY);
			ChangeStat(p.state, p.target, 1, Stat.EVASION);
		...
		public static async Task<u32> Effect_FairyLock(MoveEffectParams p) {
			// TODO:
			//p.target.GiveStatus(Status.CANT_ESCAPE;
			//MessageBox(Lang.GetBattleMessage(BattleMessage.NO_ONE_CAN_ESCAPE));
			return 0;
		}
		...
		public static async Task<u32> Effect_GuardSplit(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.GUARD_SPLIT, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_GuardSwap(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.GUARD_SWAP, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_HeartSwap(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SWITCHED_STAT_CHANGES_WITH_TARGET, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_MagnetRise(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_BEGAN_LEVITATING, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_NoRetreat(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_CAN_NO_LONGER_ESCAPE, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_PowerShift(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SWITCHED_ITS_ATTACK_AND_DEFENSE, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_PowerSplit(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.POWER_SPLIT, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_PowerSwap(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.POWER_SWAP, p.attacker.GetName()));
		...
		public static async Task<u32> Effect_SpectralThief(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.STAT_CHANGES_REMOVED, p.attacker.GetName()));

			if (atk > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-atk), Stat.ATTACK);
				ChangeStat(p.state, p.attacker, atk, Stat.ATTACK);
			}
			if (def > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-def), Stat.DEFENSE);
				ChangeStat(p.state, p.attacker, def, Stat.DEFENSE);
			}
			if (spAtk > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-spAtk), Stat.SPECIAL_ATTACK);
				ChangeStat(p.state, p.attacker, spAtk, Stat.SPECIAL_ATTACK);
			}
			if (spDef > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-spDef), Stat.SPECIAL_DEFENSE);
				ChangeStat(p.state, p.attacker, spDef, Stat.SPECIAL_DEFENSE);
			}
			if (spd > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-spd), Stat.SPEED);
				ChangeStat(p.state, p.attacker, spd, Stat.SPEED);
			}
			if (acc > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-acc), Stat.ACCURACY);
				ChangeStat(p.state, p.attacker, acc, Stat.ACCURACY);
			}
			if (eva > 0) {
				ChangeStat(p.state, p.target, (sbyte)(-eva), Stat.EVASION);
				ChangeStat(p.state, p.attacker, eva, Stat.EVASION);
			}
		...
		public static async Task<u32> Effect_Tailwind(MoveEffectParams p) {
			p.state.SetSideCondition(p.attacker.Side, Condition.TAILWIND, 5);
			if (p.attacker.Side == Battle.SIDE_CLIENT) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.ALLY_TAILWIND_START));
			}
			else {
				MessageBox(Lang.GetBattleMessage(BattleMessage.ENEMY_TAILWIND_START));
			}
			return 0;
		}
		...
		public static async Task<u32> Effect_TarShot(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_BECAME_WEAKER_TO_FIRE, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Telekinesis(MoveEffectParams p) {
			// TODO:
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_HURLED_INTO_AIR, p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_ThroatChop(MoveEffectParams p) {
			...
			//MessageBox(Lang.GetBattleMessage(BattleMessage.THROAT_CHOP_PREVENTS_MON_FROM_USING_CERTAIN_MOVES));
			return 0;
		}
		...
		public static async Task<u32> Effect_TopsyTurvy(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.STAT_CHANGES_INVERTED, p.target.GetName()));
		...
		public static async Task<u32> Effect_Transform(MoveEffectParams p) {
			...
			MessageBox(Lang.GetBattleMessage(BattleMessage.MON_TRANSFORMED_INTO_MON, p.attacker.GetName(), p.target.GetName()));
			return 0;
		}
		...
		public static async Task<u32> Effect_Reflect(MoveEffectParams p) {
			...
			p.state.SetSideCondition(p.attacker.Side, Condition.REFLECT, (u8)(p.attacker.HeldItem == Item.LIGHT_CLAY ? 8 : 5));
			if (p.attacker.Side == Battle.SIDE_CLIENT) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.ALLY_REFLECT));
			}
			else {
				MessageBox(Lang.GetBattleMessage(BattleMessage.OPPONENT_REFLECT));
			}
			return 0;
		}
		public static async Task<u32> Effect_LightScreen(MoveEffectParams p) {
			...
			p.state.SetSideCondition(p.attacker.Side, Condition.LIGHT_SCREEN, (u8)(p.attacker.HeldItem == Item.LIGHT_CLAY ? 8 : 5));
			if (p.attacker.Side == Battle.SIDE_CLIENT) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.ALLY_LIGHT_SCREEN));
			}
			else {
				MessageBox(Lang.GetBattleMessage(BattleMessage.OPPONENT_LIGHT_SCREEN));
			}
			return 0;
		}
		public static async Task<u32> Effect_AuroraVeil(MoveEffectParams p) {
			...
			p.state.SetSideCondition(p.attacker.Side, Condition.AURORA_VEIL, (u8)(p.attacker.HeldItem == Item.LIGHT_CLAY ? 8 : 5));
			if (p.attacker.Side == Battle.SIDE_CLIENT) {
				MessageBox(Lang.GetBattleMessage(BattleMessage.ALLY_AURORA_VEIL));
			}
			else {
				MessageBox(Lang.GetBattleMessage(BattleMessage.OPPONENT_AURORA_VEIL));
			}
			return 0;
		}
