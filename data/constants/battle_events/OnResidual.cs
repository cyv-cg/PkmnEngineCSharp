...
namespace PkmnEngine {
	...
	internal static partial class BattleEvents {
		...
		public static object Status_Taunt_OnResidual(object p) {
			...
			if (count == 0) {
				args.bm.RemoveStatus(Status.THROAT_CHOP);
				MessageBox(Lang.GetBattleMessage(BattleMessage.MON_SHOOK_OFF_THE_TAUNT, args.bm.GetName()));
			}
		...
		public static object Status_Encore_OnResidual(object p) {
			...
			if (args.bm.GetStatusParam(StatusParam.ENCORE_TURNS) == 0) {
				...
				MessageBox(Lang.GetBattleMessage(BattleMessage.MONS_ENCORE_ENDED, args.bm.GetName()));
			}
		...
		public static object Status_Disable_OnResidual(object p) {
			...
			if (args.bm.GetStatusParam(StatusParam.DISABLE) == 0) {
				...
				MessageBox(Lang.GetBattleMessage(BattleMessage.MONS_MOVE_NO_LONGER_DISABLED, args.bm.GetName()));
			}
